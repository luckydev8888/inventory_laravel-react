...
function Customers() {
    ...
    const columns = [
        ...
        { field: 'customer_payment_status', headerName: 'Payment Status', flex: 1 },
        { field: 'customer_credit_amnt', headerName: 'Credit Amount', flex: 1 },
        ...
        .then(response => {
            const transformedData = response.data.customers.map(customer => {
                ...
                return {
                    ...
                    customer_credit_amnt: customer['customer_credit_amnt'],
    ...
    const get_customer = (editIndexValue, customer_id) => {
        ...
        .then(response => {
            ...
            setImgSrc(process.env.REACT_APP_API_BASE_IMG_URL + '/storage/' + cleanedPath);
