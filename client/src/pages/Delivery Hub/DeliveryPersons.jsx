                                    ...
                                    <TextField
                                        ...
                                        InputProps={{
                                            ...
                                            <InputAdornment position="start">
                                                ...
                                                >
                                                    Upload Image
                                                    <VisuallyHiddenInput type="file" name="primary_id_img" accept=".png, .jpeg, .jpg, .gif" onChange={handleChange} />
                                                </Button>
                                            </InputAdornment>
                                            ),
                                    ...
                                    <TextField
                                        ...
                                        InputProps={{
                                            ...
                                            <InputAdornment position="start">
                                                ...
                                                >
                                                    Upload Image
                                                    <VisuallyHiddenInput type="file" accept=".png, .jpeg, .jpg, .gif" name="secondary_id_img" onChange={handleChange} />
                                                </Button>
                                            </InputAdornment>
                                            ),
                                            endAdornment: <InputAdornment position="end"><AttachmentOutlined /></InputAdornment>,
